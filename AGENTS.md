...
- **Lint**: `golangci-lint run` (requires golangci-lint latest)
...
- **Commit messages**: start with a capitalized verb in the present tense, write in concise English, describe purpose/intent rather than the change itself
