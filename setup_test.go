...
func TestSetup(t *testing.T) {
	tests := []struct {
		...
		{name: "two-hosts-tcp", input: "fanout . 127.0.0.1 127.0.0.2 {\nnetwork tcp\n}", expectedFrom: ".", expectedTimeout: defaultTimeout, expectedAttempts: 3, expectedWorkers: 2, expectedNetwork: "tcp", expectedRace: false, expectedRaceContinueOnErrorResponse: false, expectedTo: []string{localDNS53, "127.0.0.2:53"}, expectedServerCount: 2, expectedLoadFactor: nil, expectedPolicy: ""},
